...
int getAge(int a, int b) => _bindings.get_age(a, b);

Pointer<Char> getName(int a, int b) => _bindings.get_name(a, b);

Pointer<Char> encryptString(Pointer<Char> string) =>
    _bindings.encrypt_string(string);
